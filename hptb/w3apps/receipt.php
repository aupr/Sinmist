...
<div class="controller"><div class="cheader">Print Control</div>
    <div class="holder">
        ...
        <button id="close-btn">Close Receipt</button>
    </div>
...
<div class="wrapper">
    ...
    <div id="rPage_1" class="masterClass">
        ...
        <div class="singlePage"><?=$pageHeader?>
            <div class="reportPageHeadText">receipt for <?=$dbData['data']['pumpType']?></div>
            ...
            <div class="vendorMsg">
                the above mentioned pump is received with thanks by <br> mechanical engineering department.
            </div>
            <div class="author">
